...
_SYSTEM = (
    ...
    "-- do not guess. "
    "\n\n"
    "NEVER NAME THE SOURCE. These messages come from private channels and closed communities. Do "
    "not name the channel, do not link it, do not mention Telegram, and do not write any 'source' "
    "or credit line anywhere in a title or a description -- the event carries no attribution at "
    "all, by design. Do not output source_url or url_route. url_registration may carry a "
    "registration link ONLY when the announcement itself gives an external one (a form, a race "
    "site); never a t.me link. Write no images and no embeds -- no <img>, <video>, <iframe> or "
    "<picture>; a description is text. "
    "\n\n"
